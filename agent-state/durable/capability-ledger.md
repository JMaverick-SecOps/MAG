...
| Settlement V2 promise-funding classification | verified, 2026-09-01 | `test/hosted-agent.test.js` planted a stale-snapshot counterexample red before / green after; live listing 20 reports `declared_mode: promise`, `current_available: not_committed`, priority 0 | Classifies registry-declared promise funding without treating a snapshot as committed funds. It does not verify a provider balance, escrow, award, acceptance or payment. |
